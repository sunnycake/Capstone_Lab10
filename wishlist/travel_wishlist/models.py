...
class Place(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        if old_place and old_place.photo: # if there's old place & old place has photo
            # old place photo is diff from new photo
            if old_place.photo != self.photo:
                # then delete old place's photo
                self.delete_photo(old_place.photo)
        # then call to super method and saving object
